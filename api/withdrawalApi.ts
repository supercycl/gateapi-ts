...
export class WithdrawalApi {
     ...
     * @param ledgerRecord
     */
    public async withdraw(ledgerRecord: LedgerRecord): Promise<{ response: Response; body: LedgerRecord }> {
    ...
    ): Promise<{ response: Response; body: UidPushWithdrawalResp }> {
     ...
     * @param withdrawalId
     */
    public async cancelWithdrawal(withdrawalId: string): Promise<{ response: Response; body: LedgerRecord }> {
        const localVarPath =
