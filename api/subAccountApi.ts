...
export class SubAccountApi {
    ...
    public async listSubAccounts(opts: {
        type?: string;
    }): Promise<{ response: Response; body: Array<SubAccount> }> {
     ...
     * @param subAccount
     */
    public async createSubAccounts(subAccount: SubAccount): Promise<{ response: Response; body: SubAccount }> {
        const localVarPath = this.client.basePath + '/sub_accounts';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async getSubAccount(userId: number): Promise<{ response: Response; body: SubAccount }> {
        const localVarPath =
     ...
     * @param userId Sub-account user id
     */
    public async listSubAccountKeys(userId: number): Promise<{ response: Response; body: Array<SubAccountKey> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<SubAccountKey> }> {
        const localVarPath =
            this.client.basePath +
            '/sub_accounts/{user_id}/keys'.replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
        const localVarQueryParameters: any = {};
    ...
    public async getSubAccountKey(
        userId: number,
        key: string,
    ): Promise<{ response: Response; body: SubAccountKey }> {
        const localVarPath =
            this.client.basePath +
     ...
     * @param key The API Key of the sub-account
     */
    public async deleteSubAccountKeys(userId: number, key: string): Promise<{ response: Response; body?: any }> {
        const localVarPath =
            this.client.basePath +
            '/sub_accounts/{user_id}/keys/{key}'
                .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)))
     ...
     */
    public async lockSubAccount(userId: number): Promise<{ response: Response; body?: any }> {
        const localVarPath =
            this.client.basePath +
     ...
     * @param userId The user id of the sub-account
     */
    public async unlockSubAccount(userId: number): Promise<{ response: Response; body?: any }> {
        const localVarPath =
            this.client.basePath +
     ...
     */
    public async listUnifiedMode(): Promise<{ response: Response; body: Array<SubUserMode> }> {
