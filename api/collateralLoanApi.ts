...
export class CollateralLoanApi {
    ...
    }): Promise<{ response: Response; body: Array<CollateralOrder> }> {
    ...
    public async getCollateralLoanOrderDetail(
        orderId: number,
    ): Promise<{ response: Response; body: CollateralOrder }> {
        const localVarPath =
     ...
     * @param repayLoan
     */
    public async repayCollateralLoan(repayLoan: RepayLoan): Promise<{ response: Response; body: RepayResp }> {
    ...
    ): Promise<{ response: Response; body: Array<RepayRecord> }> {
    ...
    public async listCollateralRecords(opts: {
        ...
        borrowCurrency?: string;
        collateralCurrency?: string;
    }): Promise<{ response: Response; body: Array<CollateralRecord> }> {
     ...
     */
    public async operateCollateral(collateralAlign: CollateralAlign): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/loan/collateral/collaterals';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
     ...
     */
    public async getUserTotalAmount(): Promise<{ response: Response; body: UserTotalAmount }> {
    ...
    public async getUserLtvInfo(
        collateralCurrency: string,
        borrowCurrency: string,
    ): Promise<{ response: Response; body: UserLtvInfo }> {
    ...
    public async listCollateralCurrencies(opts: {
        loanCurrency?: string;
    }): Promise<{ response: Response; body: Array<CollateralLoanCurrency> }> {
