...
export class WalletApi {
    ...
    public async listCurrencyChains(
        currency: string,
    ): Promise<{ response: Response; body: Array<CurrencyChain> }> {
     ...
     * @param currency Currency name
     */
    public async getDepositAddress(currency: string): Promise<{ response: Response; body: DepositAddress }> {
    ...
    public async listWithdrawals(opts: {
        ...
        limit?: number;
        offset?: number;
    }): Promise<{ response: Response; body: Array<WithdrawalRecord> }> {
    ...
    public async listDeposits(opts: {
        ...
        limit?: number;
        offset?: number;
    }): Promise<{ response: Response; body: Array<LedgerRecord> }> {
     ...
     * @param transfer
     */
    public async transfer(transfer: Transfer): Promise<{ response: Response; body: TransactionID }> {
    ...
    public async listSubAccountTransfers(opts: {
        ...
        limit?: number;
        offset?: number;
    }): Promise<{ response: Response; body: Array<SubAccountTransfer> }> {
    ...
    ): Promise<{ response: Response; body: TransactionID }> {
        const localVarPath = this.client.basePath + '/wallet/sub_account_transfers';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
    ...
    public async getTransferOrderStatus(opts: {
        ...
        txId?: string;
    }): Promise<{ response: Response; body: TransferOrderStatus }> {
    ...
    public async listWithdrawStatus(opts: {
        currency?: string;
    }): Promise<{ response: Response; body: Array<WithdrawStatus> }> {
    ...
    public async listSubAccountBalances(opts: {
        subUid?: string;
    }): Promise<{ response: Response; body: Array<SubAccountBalance> }> {
    ...
    public async listSubAccountMarginBalances(opts: {
        subUid?: string;
    }): Promise<{ response: Response; body: Array<SubAccountMarginBalance> }> {
    ...
    public async listSubAccountFuturesBalances(opts: {
        subUid?: string;
        settle?: string;
    }): Promise<{ response: Response; body: Array<SubAccountFuturesBalance> }> {
    ...
    public async listSubAccountCrossMarginBalances(opts: {
        subUid?: string;
    }): Promise<{ response: Response; body: Array<SubAccountCrossMarginBalance> }> {
    ...
    ): Promise<{ response: Response; body: Array<SavedAddress> }> {
    ...
    public async getTradeFee(opts: {
        currencyPair?: string;
        settle?: 'BTC' | 'USDT' | 'USD';
    }): Promise<{ response: Response; body: TradeFee }> {
    ...
    public async getTotalBalance(opts: {
        currency?: string;
    }): Promise<{ response: Response; body: TotalBalance }> {
     ...
     */
    public async listSmallBalance(): Promise<{ response: Response; body: Array<SmallBalance> }> {
    ...
    public async listSmallBalanceHistory(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<SmallBalanceHistory> }> {
    ...
    }): Promise<{ response: Response; body: Array<UidPushOrder> }> {
