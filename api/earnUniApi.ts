...
export class EarnUniApi {
     ...
     */
    public async listUniCurrencies(): Promise<{ response: Response; body: Array<UniCurrency> }> {
     ...
     */
    public async getUniCurrency(currency: string): Promise<{ response: Response; body: UniCurrency }> {
        const localVarPath =
    ...
    public async listUserUniLends(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<UniLend> }> {
     ...
     * @param createUniLend
     */
    public async createUniLend(createUniLend: CreateUniLend): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/earn/uni/lends';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
     ...
     * @param patchUniLend
     */
    public async changeUniLend(patchUniLend: PatchUniLend): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/earn/uni/lends';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
    ...
    public async listUniLendRecords(opts: {
        ...
        to?: number;
        type?: 'lend' | 'redeem';
    }): Promise<{ response: Response; body: Array<UniLendRecord> }> {
     ...
     * @param currency Currency
     */
    public async getUniInterest(currency: string): Promise<{ response: Response; body: UniLendInterest }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listUniInterestRecords(opts: {
        ...
        from?: number;
        to?: number;
    }): Promise<{ response: Response; body: Array<UniInterestRecord> }> {
    ...
    public async getUniInterestStatus(
        currency: string,
    ): Promise<{ response: Response; body: UniCurrencyInterest }> {
        const localVarPath =
            this.client.basePath +
