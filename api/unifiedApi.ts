...
export class UnifiedApi {
    ...
    public async listUnifiedAccounts(opts: {
        currency?: string;
        subUid?: string;
    }): Promise<{ response: Response; body: UnifiedAccount }> {
     ...
     */
    public async getUnifiedBorrowable(currency: string): Promise<{ response: Response; body: UnifiedBorrowable }> {
    ...
    public async getUnifiedTransferable(
        currency: string,
    ): Promise<{ response: Response; body: UnifiedTransferable }> {
    ...
    public async listUnifiedLoans(opts: {
        ...
        limit?: number;
        type?: string;
    }): Promise<{ response: Response; body: Array<UniLoan> }> {
     ...
     * @param unifiedLoan
     */
    public async createUnifiedLoan(unifiedLoan: UnifiedLoan): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/unified/loans';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
    ...
    public async listUnifiedLoanRecords(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<UnifiedLoanRecord> }> {
     ...
     */
    public async getUnifiedRiskUnits(): Promise<{ response: Response; body: UnifiedRiskUnits }> {
     ...
     */
    public async getUnifiedMode(): Promise<{ response: Response; body: UnifiedModeSet }> {
     ...
     */
    public async setUnifiedMode(unifiedModeSet: UnifiedModeSet): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/unified/unified_mode';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
     ...
     */
    public async listCurrencyDiscountTiers(): Promise<{ response: Response; body: Array<UnifiedDiscount> }> {
     ...
     */
    public async listLoanMarginTiers(): Promise<{ response: Response; body: Array<UnifiedMarginTiers> }> {
    ...
    ): Promise<{ response: Response; body: UnifiedPortfolioOutput }> {
    ...
    public async getUserLeverageCurrencyConfig(
        currency: string,
    ): Promise<{ response: Response; body: UnifiedLeverageConfig }> {
    ...
    public async getUserLeverageCurrencySetting(opts: {
        currency?: string;
    }): Promise<{ response: Response; body: UnifiedLeverageSetting }> {
    ...
    public async listUnifiedCurrencies(opts: {
        currency?: string;
    }): Promise<{ response: Response; body: Array<UnifiedCurrency> }> {
    ...
    ): Promise<{ response: Response; body: UnifiedHistoryLoanRate }> {
