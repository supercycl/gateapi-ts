...
export class MarginUniApi {
     ...
     */
    public async listUniCurrencyPairs(): Promise<{ response: Response; body: Array<UniCurrencyPair> }> {
     ...
     */
    public async getUniCurrencyPair(currencyPair: string): Promise<{ response: Response; body: UniCurrencyPair }> {
        const localVarPath =
     ...
     * @param createUniLoan
     */
    public async createUniLoan(createUniLoan: CreateUniLoan): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/margin/uni/loans';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
    ...
    public async listUniLoanRecords(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<UniLoanRecord> }> {
    ...
    public async getUniBorrowable(
        currency: string,
        currencyPair: string,
    ): Promise<{ response: Response; body: MaxUniBorrowable }> {
