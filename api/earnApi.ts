...
export class EarnApi {
     ...
     * @param eth2Swap
     */
    public async swapETH2(eth2Swap: Eth2Swap): Promise<{ response: Response; body?: any }> {
     ...
     */
    public async rateListETH2(): Promise<{ response: Response; body: Array<Eth2RateList> }> {
    ...
    public async listDualInvestmentPlans(opts: {
        planId?: number;
    }): Promise<{ response: Response; body: Array<DualGetPlans> }> {
    ...
    public async listDualOrders(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<DualGetOrders> }> {
    ...
    ): Promise<{ response: Response; body: Array<StructuredGetProjectList> }> {
    ...
    public async listStructuredOrders(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<StructuredOrderList> }> {
     ...
     * @param structuredBuy
     */
    public async placeStructuredOrder(structuredBuy: StructuredBuy): Promise<{ response: Response; body?: any }> {
        const localVarPath = this.client.basePath + '/earn/structured/orders';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
