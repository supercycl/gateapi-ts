...
export class SpotApi {
     ...
     */
    public async listCurrencies(): Promise<{ response: Response; body: Array<Currency> }> {
     ...
     */
    public async getCurrency(currency: string): Promise<{ response: Response; body: Currency }> {
        const localVarPath =
     ...
     */
    public async listCurrencyPairs(): Promise<{ response: Response; body: Array<CurrencyPair> }> {
     ...
     */
    public async getCurrencyPair(currencyPair: string): Promise<{ response: Response; body: CurrencyPair }> {
        const localVarPath =
            this.client.basePath +
    ...
    }): Promise<{ response: Response; body: Array<Ticker> }> {
    ...
    ): Promise<{ response: Response; body: OrderBook }> {
    ...
    ): Promise<{ response: Response; body: Array<Trade> }> {
    ...
    ): Promise<{ response: Response; body: Array<Array<string>> }> {
     ...
     */
    public async getFee(opts: { currencyPair?: string }): Promise<{ response: Response; body: SpotFee }> {
    ...
    ): Promise<{ response: Response; body: { [key: string]: SpotFee } }> {
    ...
    public async listSpotAccounts(opts: {
        currency?: string;
    }): Promise<{ response: Response; body: Array<SpotAccount> }> {
    ...
    public async listSpotAccountBook(opts: {
        ...
        limit?: number;
        type?: string;
    }): Promise<{ response: Response; body: Array<SpotAccountBook> }> {
    ...
    ): Promise<{ response: Response; body: Array<BatchOrder> }> {
    ...
    public async listAllOpenOrders(opts: {
        ...
        limit?: number;
        account?: string;
    }): Promise<{ response: Response; body: Array<OpenOrders> }> {
    ...
    ): Promise<{ response: Response; body: Order }> {
    ...
    ): Promise<{ response: Response; body: Array<Order> }> {
    ...
    public async cancelOrders(opts: {
        ...
        actionMode?: string;
        xGateExptime?: number;
    }): Promise<{ response: Response; body: Array<OrderCancel> }> {
        const localVarPath = this.client.basePath + '/spot/orders';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
    ...
    public async cancelBatchOrders(
        ...
        opts: { xGateExptime?: number },
    ): Promise<{ response: Response; body: Array<CancelOrderResult> }> {
     ...
     */
    public async getSystemTime(): Promise<{ response: Response; body: SystemTime }> {
    ...
    ): Promise<{ response: Response; body: Array<SpotInsuranceHistory> }> {
    ...
    ): Promise<{ response: Response; body: Array<SpotPriceTriggeredOrder> }> {
    ...
    public async getSpotPriceTriggeredOrder(
        orderId: string,
    ): Promise<{ response: Response; body: SpotPriceTriggeredOrder }> {
        const localVarPath =
            this.client.basePath +
