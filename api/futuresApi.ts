...
export class FuturesApi {
    ...
    ): Promise<{ response: Response; body: Array<Contract> }> {
        const localVarPath =
    ...
    public async getFuturesContract(
        settle: 'btc' | 'usdt',
        contract: string,
    ): Promise<{ response: Response; body: Contract }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listFuturesPremiumIndex(
        ...
        contract: string,
        opts: { from?: number; to?: number; limit?: number; interval?: string },
    ): Promise<{ response: Response; body: Array<FuturesPremiumIndex> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesTicker> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FundingRateRecord> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listFuturesInsuranceLedger(
        settle: 'btc' | 'usdt',
        opts: { limit?: number },
    ): Promise<{ response: Response; body: Array<InsuranceRecord> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<ContractStat> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async getIndexConstituents(
        settle: 'btc' | 'usdt',
        index: string,
    ): Promise<{ response: Response; body: FuturesIndexConstituents }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesLiqOrder> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesLimitRiskTiers> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listFuturesAccounts(
        settle: 'btc' | 'usdt',
    ): Promise<{ response: Response; body: FuturesAccount }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesAccountBook> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<Position> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async getPosition(
        settle: 'btc' | 'usdt',
        contract: string,
    ): Promise<{ response: Response; body: Position }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesOrder> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: FuturesOrder }> {
        const localVarPath =
            this.client.basePath +
            '/futures/{settle}/orders'.replace('{' + 'settle' + '}', encodeURIComponent(String(settle)));
        const localVarQueryParameters: any = {};
    ...
    public async createBatchFuturesOrder(
        ...
        opts: { xGateExptime?: number },
    ): Promise<{ response: Response; body: Array<BatchFuturesOrder> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<MyFuturesTrade> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<MyFuturesTradeTimeRange> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<PositionClose> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<FuturesLiquidate> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listAutoDeleverages(
        settle: 'btc' | 'usdt',
        opts: { contract?: string; limit?: number; at?: number },
    ): Promise<{ response: Response; body: Array<FuturesAutoDeleverage> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async getFuturesFee(
        settle: 'btc' | 'usdt',
        opts: { contract?: string },
    ): Promise<{ response: Response; body: { [key: string]: FuturesFee } }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async cancelBatchFutureOrders(
        ...
        opts: { xGateExptime?: number },
    ): Promise<{ response: Response; body: Array<FutureCancelOrderResult> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listPriceTriggeredOrders(
        ...
        opts: { contract?: string; limit?: number; offset?: number },
    ): Promise<{ response: Response; body: Array<FuturesPriceTriggeredOrder> }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: TriggerOrderResponse }> {
        const localVarPath =
            this.client.basePath +
            '/futures/{settle}/price_orders'.replace('{' + 'settle' + '}', encodeURIComponent(String(settle)));
        const localVarQueryParameters: any = {};
    ...
    public async getPriceTriggeredOrder(
        settle: 'btc' | 'usdt',
        orderId: string,
    ): Promise<{ response: Response; body: FuturesPriceTriggeredOrder }> {
        const localVarPath =
            this.client.basePath +
