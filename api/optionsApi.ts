...
export class OptionsApi {
     ...
     */
    public async listOptionsUnderlyings(): Promise<{ response: Response; body: Array<OptionsUnderlying> }> {
     ...
     */
    public async listOptionsExpirations(underlying: string): Promise<{ response: Response; body: Array<number> }> {
    ...
    ): Promise<{ response: Response; body: Array<OptionsContract> }> {
     ...
     * @param contract
     */
    public async getOptionsContract(contract: string): Promise<{ response: Response; body: OptionsContract }> {
        const localVarPath =
    ...
    ): Promise<{ response: Response; body: Array<OptionsSettlement> }> {
    ...
    public async getOptionsSettlement(
        ...
        underlying: string,
        at: number,
    ): Promise<{ response: Response; body: OptionsSettlement }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<OptionsMySettlements> }> {
    ...
    ): Promise<{ response: Response; body: FuturesOrderBook }> {
    ...
    public async listOptionsTickers(
        underlying: string,
    ): Promise<{ response: Response; body: Array<OptionsTicker> }> {
    ...
    public async listOptionsUnderlyingTickers(
        underlying: string,
    ): Promise<{ response: Response; body: OptionsUnderlyingTicker }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<OptionsCandlestick> }> {
    ...
    public async listOptionsUnderlyingCandlesticks(
        underlying: string,
        opts: { limit?: number; from?: number; to?: number; interval?: '1m' | '5m' | '15m' | '30m' | '1h' },
    ): Promise<{ response: Response; body: Array<FuturesCandlestick> }> {
    ...
    public async listOptionsTrades(opts: {
        ...
        from?: number;
        to?: number;
    }): Promise<{ response: Response; body: Array<FuturesTrade> }> {
     ...
     */
    public async listOptionsAccount(): Promise<{ response: Response; body: OptionsAccount }> {
    ...
    }): Promise<{ response: Response; body: Array<OptionsAccountBook> }> {
    ...
    public async listOptionsPositions(opts: {
        underlying?: string;
    }): Promise<{ response: Response; body: Array<OptionsPosition> }> {
     ...
     * @param contract
     */
    public async getOptionsPosition(contract: string): Promise<{ response: Response; body: OptionsPosition }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<OptionsPositionClose> }> {
    ...
    ): Promise<{ response: Response; body: Array<OptionsOrder> }> {
    ...
    ): Promise<{ response: Response; body: OptionsOrder }> {
        const localVarPath = this.client.basePath + '/options/orders';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async getOptionsOrder(orderId: number): Promise<{ response: Response; body: OptionsOrder }> {
        const localVarPath =
            this.client.basePath +
     ...
     * @param orderId Order ID returned on successful order creation
     */
    public async cancelOptionsOrder(orderId: number): Promise<{ response: Response; body: OptionsOrder }> {
        const localVarPath =
            this.client.basePath +
            '/options/orders/{order_id}'.replace('{' + 'order_id' + '}', encodeURIComponent(String(orderId)));
        const localVarQueryParameters: any = {};
    ...
    ): Promise<{ response: Response; body: TriggerTime }> {
    ...
    public async listMyOptionsTrades(
        underlying: string,
        opts: { contract?: string; limit?: number; offset?: number; from?: number; to?: number },
    ): Promise<{ response: Response; body: Array<OptionsMyTrade> }> {
    ...
    public async getOptionsMMP(opts: {
        underlying?: string;
    }): Promise<{ response: Response; body: Array<OptionsMMP> }> {
     ...
     * @param optionsMMP
     */
    public async setOptionsMMP(optionsMMP: OptionsMMP): Promise<{ response: Response; body: OptionsMMP }> {
        const localVarPath = this.client.basePath + '/options/mmp';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
    ...
    ): Promise<{ response: Response; body: OptionsMMP }> {
