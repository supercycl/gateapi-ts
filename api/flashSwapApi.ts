...
export class FlashSwapApi {
    ...
    public async listFlashSwapCurrencyPair(opts: {
        ...
        page?: number;
        limit?: number;
    }): Promise<{ response: Response; body: Array<FlashSwapCurrencyPair> }> {
    ...
    public async listFlashSwapOrders(opts: {
        ...
        limit?: number;
        page?: number;
    }): Promise<{ response: Response; body: Array<FlashSwapOrder> }> {
    ...
    ): Promise<{ response: Response; body: FlashSwapOrder }> {
        const localVarPath = this.client.basePath + '/flash_swap/orders';
        const localVarQueryParameters: any = {};
        const localVarHeaderParams: any = (<any>Object).assign({}, this.client.defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async getFlashSwapOrder(orderId: number): Promise<{ response: Response; body: FlashSwapOrder }> {
        const localVarPath =
    ...
    ): Promise<{ response: Response; body: FlashSwapOrderPreview }> {
