...
export class DeliveryApi {
    ...
    public async listDeliveryContracts(
        settle: 'usdt',
    ): Promise<{ response: Response; body: Array<DeliveryContract> }> {
        const localVarPath =
    ...
    public async getDeliveryContract(
        settle: 'usdt',
        contract: string,
    ): Promise<{ response: Response; body: DeliveryContract }> {
        const localVarPath =
            this.client.basePath +
    ...
    ): Promise<{ response: Response; body: Array<DeliveryCandlestick> }> {
        const localVarPath =
            this.client.basePath +
     ...
     * @param settle Settle currency
     */
    public async listDeliveryAccounts(settle: 'usdt'): Promise<{ response: Response; body: FuturesAccount }> {
        const localVarPath =
            this.client.basePath +
     ...
     * @param settle Settle currency
     */
    public async listDeliveryPositions(settle: 'usdt'): Promise<{ response: Response; body: Array<Position> }> {
        const localVarPath =
            this.client.basePath +
    ...
    public async listDeliverySettlements(
        settle: 'usdt',
        opts: { contract?: string; limit?: number; at?: number },
    ): Promise<{ response: Response; body: Array<DeliverySettlement> }> {
        const localVarPath =
            this.client.basePath +
